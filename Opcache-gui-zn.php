...
<head>
    ...
    <title>OPcache统计 <?= $opcache->getData('version', 'host'); ?></title>
    <link rel="icon" type="" href="https://www.jiangjiyue.com/wp-content/uploads/2021/05/circle-cropped.png" type="image/x-icon">
...
function MainNavigation(props) {
  return /*#__PURE__*/React.createElement("nav", {
    ...
    label: `${props.realtime ? '禁用' : '启用'}实时更新`,
...
function GeneralInfo(props) {
  return /*#__PURE__*/React.createElement("table", {
    ...
    colSpan: "2"
  }, "基本信息"))), /*#__PURE__*/React.createElement("tbody", null, /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("td", null, "Zend OPcache"), /*#__PURE__*/React.createElement("td", null, props.version.version)), /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("td", null, "PHP"), /*#__PURE__*/React.createElement("td", null, props.version.php)), /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("td", null, "主机"), /*#__PURE__*/React.createElement("td", null, props.version.host)), /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("td", null, "服务器软件"), /*#__PURE__*/React.createElement("td", null, props.version.server)), props.start ? /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("td", null, "开始时间"), /*#__PURE__*/React.createElement("td", null, props.start)) : null, props.reset ? /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("td", null, "上次重置"), /*#__PURE__*/React.createElement("td", null, props.reset)) : null));
}
...
function Directives(props) {
  ...
  return /*#__PURE__*/React.createElement("table", {
    ...
    colSpan: "2"
  }, "指令"))), /*#__PURE__*/React.createElement("tbody", null, directiveNodes));
}
...
function Functions(props) {
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "tables"
  }, /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("th", null, "可用功能"))), /*#__PURE__*/React.createElement("tbody", null, props.functions.map(f => /*#__PURE__*/React.createElement("tr", {
    key: f
...
function MemoryUsagePanel(props) {
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "widget-header"
  }, "内存使用情况"), /*#__PURE__*/React.createElement("div", {
    className: "widget-value widget-info"
  }, /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("b", null, "总内存:"), " ", props.total), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("b", null, "已用内存:"), " ", props.used), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("b", null, "可用内存:"), " ", props.free), props.preload && /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("b", null, "preload memory:"), " ", props.preload), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("b", null, "浪费的内存:"), " ", props.wasted, " (", props.wastedPercent, "%)"), props.jitBuffer && /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("b", null, "jit buffer:"), " ", props.jitBuffer), props.jitBufferFree && /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("b", null, "jit buffer free:"), " ", props.jitBufferFree, " (", 100 - props.jitBufferFreePercentage, "%)")));
}
...
function StatisticsPanel(props) {
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "widget-header"
  }, "opcache 统计信息"), /*#__PURE__*/React.createElement("div", {
    className: "widget-value widget-info"
  }, /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("b", null, "缓存文件数:"), " ", props.num_cached_scripts), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("b", null, "命中数:"), " ", props.hits), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("b", null, "未命中数:"), " ", props.misses), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("b", null, "黑名单未命中:"), " ", props.blacklist_miss), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("b", null, "缓存键数:"), " ", props.num_cached_keys), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("b", null, "最大缓存键数:"), " ", props.max_cached_keys)));
}
...
function InternedStringsPanel(props) {
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "widget-header"
  }, "字符串使用"), /*#__PURE__*/React.createElement("div", {
    className: "widget-value widget-info"
  }, /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("b", null, "缓冲区大小:"), " ", props.buffer_size), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("b", null, "已用内存:"), " ", props.strings_used_memory), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("b", null, "可用内存:"), " ", props.strings_free_memory), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("b", null, "字符串数:"), " ", props.number_of_strings)));
}
...
class CachedFiles extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("form", {
      ...
      htmlFor: "frmFilter"
    }, "开始输入以过滤脚本路径"), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("input", {
      type: "text",
      name: "filter",
      id: "frmFilter",
    ...
    })), /*#__PURE__*/React.createElement("h3", null, allFilesTotal, " 文件已缓存", showingTotal !== allFilesTotal && `, ${showingTotal} showing due to filter '${this.state.searchTerm}'`), this.props.allow.invalidate && this.state.searchTerm && showingTotal !== allFilesTotal && /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("a", {
    ...
    }, "最后使用"), /*#__PURE__*/React.createElement("option", {
      value: "full_path"
    }, "路径"), /*#__PURE__*/React.createElement("option", {
      value: "hits"
    }, "命中数"), /*#__PURE__*/React.createElement("option", {
      value: "memory_consumption"
    }, "内存消耗")), /*#__PURE__*/React.createElement("select", {
      name: "sortDir",
      onChange: this.changeSort,
      value: this.state.sortDir
    }, /*#__PURE__*/React.createElement("option", {
      value: "desc"
    }, "降序"), /*#__PURE__*/React.createElement("option", {
      value: "asc"
    }, "升序")))), /*#__PURE__*/React.createElement("table", {
      className: "tables cached-list-table"
    }, /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("th", null, "脚本"))), /*#__PURE__*/React.createElement("tbody", null, filesInPage.map((file, index) => {
...
class CachedFile extends React.Component {
  ...
  render() {
    ...
    }, /*#__PURE__*/React.createElement("b", null, "点击数: "), /*#__PURE__*/React.createElement("span", null, this.props.readable.hits, ", "), /*#__PURE__*/React.createElement("b", null, "内存: "), /*#__PURE__*/React.createElement("span", null, this.props.readable.memory_consumption, ", "), /*#__PURE__*/React.createElement("b", null, "最后使用时间: "), /*#__PURE__*/React.createElement("span", null, this.props.last_used)), !this.props.timestamp && /*#__PURE__*/React.createElement("span", {
      className: "invalid file-metainfo"
    }, " - 已失效"), this.props.canInvalidate && /*#__PURE__*/React.createElement("span", null, ",\xA0", /*#__PURE__*/React.createElement("a", {
      className: "file-metainfo",
